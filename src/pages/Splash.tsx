...
const Splash = () => {
  ...
  const handleStakeholderLogin = () => {
    ...
    const stakeholder = predefinedUsers.find(user => user.role === selectedRole) || 
                        predefinedUsers.find(user => user.role === 'student');
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-background to-[#5fb455]/10 p-4">
      <motion.div
      ...
      {!showRoleSelector ? (
        ...
        >
          ...
          <div className="bg-card rounded-lg shadow-lg p-6 flex flex-col items-center text-center">
            ...
            <Button onClick={handleStakeholderRoleSelect} className="w-full bg-[#5fb455] hover:bg-[#4ea344]">
        ...
        >
          ...
          <div className="mt-6 space-y-2">
            <Button 
              ...
              className="w-full bg-[#5fb455] hover:bg-[#4ea344]"
            >
              Continue
            </Button>
            <Button 
