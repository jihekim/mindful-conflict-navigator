              ...
              <div className="space-y-1 mt-4">
                <button
                  ...
                  className={`w-full flex items-center gap-2 px-3 py-2 rounded-md text-sm transition-colors ${
                    isActivePath('/stakeholder/chat') 
                      ? 'bg-[#5fb455] text-white' 
                      : 'hover:bg-accent'
                  }`}
                >
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-2 px-3 py-2 rounded-md text-sm transition-colors ${
                    isActivePath('/stakeholder/report') 
                      ? 'bg-[#5fb455] text-white' 
                      : 'hover:bg-accent'
                  }`}
                >
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-2 px-3 py-2 rounded-md text-sm transition-colors ${
                    isActivePath('/stakeholder/mediation-prep') 
                      ? 'bg-[#5fb455] text-white' 
                      : 'hover:bg-accent'
                  }`}
                >
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-2 px-3 py-2 rounded-md text-sm transition-colors ${
                    isActivePath('/stakeholder/share') 
                      ? 'bg-[#5fb455] text-white' 
                      : 'hover:bg-accent'
                  }`}
                >
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-2 px-3 py-2 rounded-md text-sm transition-colors ${
                    isActivePath('/stakeholder/settings') 
                      ? 'bg-[#5fb455] text-white' 
                      : 'hover:bg-accent'
                  }`}
                >
            ...
            <div className="bg-card rounded-lg shadow-subtle p-4">
              ...
              <p className="text-sm text-muted-foreground">
                {currentUser?.role === 'student' 
                  ? "Understand the situation better and find a resolution that brings healing."
                  : "Support the mediation process and foster a positive resolution for all parties."}
              </p>
            </div>
          </aside>
